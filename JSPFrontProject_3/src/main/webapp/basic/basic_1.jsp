...
/*
 *   => 변수 
        1) 변수 선언(데이터형이 없음) => 값에 따라서 자동으로 데이터형이 변경
           var => let, 상수 => const
           var의 단점은 지역변수의 스코프가 명확하지 않음
           function aaa()
           {
           ...
           => 규칙
              ...
              변수, 함수 => 소문자
              단어가 여러 개인 경우에는 대문자로 시작
           => 변수는 한 개의 데이터를 저장하는 메모리 공간
        2) 데이터형(자바스크립트에서 지원)
           let i=10 ===> i:int
           let i=10.5 ===> i:double
           ==================== i:Number
