...
public class BoardDAO {
	 ...
	 *      => 몇개 => maxIdle=10
	 *   2. 연결되어 있는 Connection의 주소를 얻어옴
	 *   3. Connection을 사용
	 *   4. 사용후에는 반드시 반환
	 *   ==============================
	 *   1. 보안이 뛰어남
	 *   2. Connection 객체의 생성을 제어
	 *   3. 미리 연결했기 때문에 연결에 소모되는 시간을 줄일 수 있음
	 *   4. 웹 프로그램에 접근하는 인원이 많아서 쉽게 다운되지 않음
	 *   5. 웹서버는 DBCP를 기본으로 하고 있음
	 *   ==> MyBatis/JPA
	 *   
	 *   JDBC => DBCP => 라이브러리(MyBatis/JPA)
	 *                          ======== 업체의 핵심
	 */
	// 미리 연결된 Connection의 주소를 가지고 옴
	public void getConnection()
	{
		try
		{
			// 저장 시 => 탐색기 형식으로 메모리 주소 저장 JNDI
	...
	public void boardInsert(BoardVO vo)
	{
		try
		{
			// 1. 미리 오라클과 연결 => Connection(10) => 주소를 가지고 옴
			getConnection();
