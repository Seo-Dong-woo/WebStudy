			        ...
			        <div class="option">
			            <div>
			                <form onsubmit="searchPlaces(); return false;" class="inline">
			                    키워드 : <input type="text" value="${addr2 } 맛집" id="keyword" size="15" readonly> 
							...
							<table class="table">
								<tr>
									<td class="text-center">
										<img src="https://www.menupan.com${vo.poster }" style="width: 100%; height: 140px" title="${vo.name }">
									</td>
								</tr>
								<tr>
									<td>${vo.name }</td>
						...
						<c:forEach var="rvo" items="${rList }">
							<table class="table">
								...
								<tr>
 								...
 								<tr style="display: none" id="u${rvo.no}" class="ups"><!-- 값을 감춤 안보이게. 수정을 눌러야 보여야 함 -->
									<td>
										<form method="post" action="../reply/update.do">
											<input type="hidden" name="type" value="2">
											<input type="hidden" name="cno" value="${vo.no }"><!-- 명소 번호 -->
											<input type="hidden" name="no" value="${rvo.no }">
											<textarea rows="5" cols="60" name="msg" style="float: left">${rvo.msg }</textarea>
											<input type="submit" value="댓글수정" style="float:left; width: 100px; height: 98px; margin-left: 2px" class="btn-primary">
										</form>
									</td>
								</tr>
							</table>
