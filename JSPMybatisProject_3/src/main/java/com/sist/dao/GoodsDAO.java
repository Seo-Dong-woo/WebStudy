...
public class GoodsDAO {
	/*
	 * <select id="goodsListData" resultType="GoodsVO" parameterType="hashmap"> <!-- vo에 존재하지않음 hashmap은 ?에 채워주는 값 -->
	 ...
	 */
	private static SqlSessionFactory ssf=CommonsDataBase.getSsf(); // ssf 파일을 다 읽음
	...
	public static List<GoodsVO> goodsListData(Map map)
	{
		...
		try
		{
			session=ssf.openSession(); // true가 있냐 없냐는 executeupdate냐 excutequery냐의 차이
