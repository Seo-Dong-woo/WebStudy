 		...
 		<main class="container clear">
		    ...
		    <tr>
		      <td width="40%" class="text-center" rowspan="8">
		        <img style="width: 100%; height: 350px" src="${vo.poster }">
		      </td>
		      <td colspan="2">
		    ...
		    <c:if test="${sessionScope.id!=null }">
		  	  <table class="table">
		  	    <tr>
		  	      <td>
		  	        <form method="post">
		  	          <textarea rows="4" cols="43" style="float: left"></textarea>
		  	          <input type="submit" value="댓글쓰기" class="btn btn-sm btn-danger" style="height: 90px; float: left;">
		  	        </form>
		  	      </td>
		  	    </tr>
		  	  </table>
